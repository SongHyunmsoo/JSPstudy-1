...
%>
	...
	*/
	...
	<form action="cookiesAcion.jsp.jsp" name="popupForm">
		<!-- 
		//<% %> : 변수 선언후에 사용
		<%="none"%>	
		태그에 속성을 정의 할때, 홀 따옴표 또는 쌍따옴표로 감싸주는 것은 
		해당 속성의 값이 어디까지인지를 정의하는 것이다.
		
		class 속성에 값을 정의 할수 있는데, 여러개 값을 정의할수 있다
		class="none w30" 
	 -->
